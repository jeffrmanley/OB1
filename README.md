...
The 20 most recent merged PRs. This list is generated from GitHub and refreshes daily. Last updated: 2026-09-15.

<!-- recent-contributions:start -->

| Contribution | What changed | Creator |
| ------------ | ------------ | ------- |
| [Catchup to Nate](dashboards/open-brain-dashboard-next/) | Catchup to Nate. | [@jeffrmanley](https://github.com/jeffrmanley) |
